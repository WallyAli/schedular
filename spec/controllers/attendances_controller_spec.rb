...
describe AttendancesController do
  ...
  let(:valid_attributes) { { "time_in" => "2014-04-15 23:40:29" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attendance as @attendance" do
        ...
        post :create, {:attendance => { "time_in" => "invalid value" }}, valid_session
        expect(assigns(:attendance)).to be_a_new(Attendance)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attendance" do
        ...
        expect_any_instance_of(Attendance).to receive(:update).with({ "time_in" => "2014-04-15 23:40:29" })
        put :update, {:id => attendance.to_param, :attendance => { "time_in" => "2014-04-15 23:40:29" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the attendance as @attendance" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Attendance).to receive(:save).and_return(false)
        put :update, {:id => attendance.to_param, :attendance => { "time_in" => "invalid value" }}, valid_session
        expect(assigns(:attendance)).to eq(attendance)
      end
